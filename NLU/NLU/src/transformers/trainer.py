...
class Trainer:
    ...
    def create_optimizer(self) -> torch.optim.Optimizer:
        ...
        vector_bank_parameters = [
            name for name, _ in self.model.named_parameters() if "vector_bank" in name
        ]
        logits_parameters = [
            name for name, _ in self.model.named_parameters() if "logits" in name
        ]
        ...
        optimizer_grouped_parameters = [
            ...
            },
            {
                "params": [
                    p
                    for n, p in self.model.named_parameters()
                    if n in vector_bank_parameters
                ],
