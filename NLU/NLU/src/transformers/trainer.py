...
class Trainer:
    ...
    def create_optimizer(self) -> torch.optim.Optimizer:
        ...
        vector_bank_parameters = [name for name, _ in self.model.named_parameters() if "vector_bank" in name]
        logits_parameters = [name for name, _ in self.model.named_parameters() if "logits" in name ]

        optimizer_grouped_parameters = [
            {
                "params": [p for n, p in self.model.named_parameters() if n in decay_parameters and \
                           n not in logits_parameters and n not in vector_bank_parameters],
                "weight_decay": self.args.weight_decay,
            },
            {
                "params": [p for n, p in self.model.named_parameters() if n not in decay_parameters and \
                           n not in logits_parameters and n not in vector_bank_parameters],
                "weight_decay": 0.0,
            },
            {
                "params": [p for n, p in self.model.named_parameters() if n in vector_bank_parameters],
                "lr": self.args.learning_rate_vector_bank,
            },
            {
                "params": [p for n, p in self.model.named_parameters() if n in logits_parameters],
                "lr": self.args.learning_rate_logits,
            },
        ]
