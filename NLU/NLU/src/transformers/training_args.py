...
class TrainingArguments:
    ...
    learning_rate_logits: float = field(
        default=1e-2, metadata={"help": "The initial learning rate for logits."}
    )
    ema_vector_bank_decay: float = field(
        default=0.01, metadata={"help": "The decay rate for the vector bank."}
    )
