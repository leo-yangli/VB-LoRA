...
class RobertaPreTrainedModel(PreTrainedModel):
    ...
    def _pre_load_hook(
        ...
        if (
            ...
            and self_state["classifier.out_proj.weight"].size()
            != state_dict["classifier.out_proj.weight"].size()
        ):
            logger.warning(
...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.vector_bank = nn.Parameter(
            torch.empty(config.num_vectors, config.vector_length)
        )
